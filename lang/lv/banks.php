...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used for working with banks.
    */
    'banks'=> "Bankas",
    'myBanks' => 'Manas bankas',
    'create' => 'Izveidot jaunu banku',
    'name' => 'Nosaukums',
    ...
    'removeBankConfirm' => 'Vai esat pārliecināti, ka gribat noņemt šo banku no testa?',
    'defaultName' => 'Noklusējuma',
