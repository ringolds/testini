    ...
    @if($answerMode=='single')
        ...
        @elseif($answerType=='App\Models\QuestionMap')
            <div class="form-group mb-3 dynamic-field-map">
                ...
                <input type="hidden" class="selected-target" name="question_map_target">
            </div>
        @endif
            ...
            <div class="row g-3 justify-content-center">
                ...
                @foreach($choices as $item)
                    ...
                    <div class="col-12 {{ $colClass }}">
                        <button type="button" 
                                class="btn btn-outline-light text-dark border p-3 w-100 h-100 shadow-sm d-flex flex-column align-items-center justify-content-center option-box"
